...
install:
	...
	cp $(DESTINATION_PATH)/usr/java/jdk8u412-b08-jre/LICENSE $(DESTINATION_PATH)/usr/share/common-licenses/java
	cp $(DESTINATION_PATH)/usr/java/jdk8u412-b08-jre/NOTICE $(DESTINATION_PATH)/usr/share/common-licenses/java
