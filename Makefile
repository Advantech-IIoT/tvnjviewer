...
JDK_TAR=$(BIN_PATH)/OpenJDK8U-jre_aarch64_linux_hotspot_8u492b09.tar.gz
...
install:
	...
	cp $(DESTINATION_PATH)/usr/java/jdk8u492-b09-jre/LICENSE $(DESTINATION_PATH)/usr/share/common-licenses/java
	cp $(DESTINATION_PATH)/usr/java/jdk8u492-b09-jre/NOTICE $(DESTINATION_PATH)/usr/share/common-licenses/java
